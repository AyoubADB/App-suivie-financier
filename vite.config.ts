...
/**
 * Identifiant de build, affiché dans les réglages.
 * Une app installée sur un écran d'accueil peut servir une version ancienne
 * sans que rien ne le signale : pouvoir lire la date du build évite de
